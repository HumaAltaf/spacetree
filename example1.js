  ...
  onBeforePlotNode: function(node){
            ...
            if(node.selected) {
                ...
                if(!node.anySubnode("exist")) {
                    ...
                    var count = 0;
                             //wn #b37700        //green        //purple    //red      // bluee     green
                    var getcolors = ['#4d4dff', '#009900', '#e6005c', '#ff3300', '#4d4dff', '#ff8533'];
                    colorLength = getcolors.length;
                    rand = Math.random,
                    floor = Math.floor,
                    ...
                    //how many children it has
                                        ...
                                        //peach      //green   // purple   //yellow   //blue    //pink
                   node.data.$color = ['#ffebcc', '#ecffb3', '#fff2cc', '#ffe5ff', '#e5f7ff', '#ffe5e5'][count];
                   //var clr = getcolors[count];
                   node.setCanvasStyle('strokeStyle', getcolors[floor(colorLength * rand())]);
                   node.setCanvasStyle('lineWidth',1);
